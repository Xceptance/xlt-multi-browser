...
public abstract class XltPropertyKey
{
    ...
    public static final String WEBDRIVER_PATH_EDGE = "xlt.webDriver.edge.pathToDriverServer";

    public static final String WEBDRIVER_PATH_OPERA = "xlt.webDriver.opera.pathToDriverServer";

    public static final String WEBDRIVER_PATH_PHANTOMJS = "xlt.webDriver.phantomjs.pathToDroverServer";
    ...
    public static final String OPERA_PATH = "xlt.webDriver.opera.pathToBrowser";
